	...
	<?php
		...
		if(isset($_GET['edit']))
		  {
			...
			$qry = "select * from user where id='$edit_id' ";
		...
		?>
					...
					<table align="center" width="450" height="500" style="padding-top:20px; padding:10px 10px;">
						...
						<tr>
							<td >Password </td>
							<td>	<input type="text" class="form_item" name="Passward" value="<?php echo $Passward; ?>" required> </td>	
						</tr>
...
<?php 
	...
	$qry = "update user set name = '$name', email='$email', Passward='$Passward', mobile='$mobile', city='$city' where id = '$edit_id'" ;
